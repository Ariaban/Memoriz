(function ($) {
    $.fn.tree_structure = function (options) {
       ...
       // var getvalue = getcode.indexOf("aeonian");
var getvalue = 32;
            ...
            if (add_option) {
                $(document).on("click", '.' + class_name + ' span.add_action', function () {
                    ...
                    if (_this.closest('div').children('form.add_data').length == 0) {
                        var addquery = '<form class="add_data" method="post" action=""><img class="close" src="images/close.png" /><input type="text" class="first_name" name="first_name" placeholder="first name"><input type="checkbox" name="showhideval" id="hide" /><label for="hide"></label><input type="submit" class="submit" name="submit" value="ثبت"></form>';
...
//                        });
            ...
            if (edit_option) {
                $(document).on("click", '.' + class_name + ' span.edit_action', function () {
                    ...
                    var _this = $(this);
                    var editquery = '<form class="edit_data" method="post" action=""><img class="close" src="images/close.png" /><input type="text" class="first_name" name="first_name" value="" placeholder="first name"><input type="checkbox"  value="" name="showhideval" id="hide" /><label for="hide"></label><input type="submit" class="edit" name="submit" value="ثبت"></form>';
